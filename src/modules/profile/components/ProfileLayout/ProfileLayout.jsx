...
const ProfileLayout = () => {
    ...
    const renderContent = () => {
        ...
        if (path.includes("/saved-address/add-address") || path.includes("/saved-address/edit-address")) return <AddressForm />;
        if (path.includes("/add-payment") || path.includes("/edit-payment")) return <PaymentForm />;
    ...
    const getContentTitle = () => {
        ...
        if (path.includes("/my-profile-orders")) return "My Orders";
        if (path.includes("/edit-my-profile")) return "Edit Profile";
        if (path.includes("/Address") && !path.includes("add-address") && !path.includes("edit-address")) return "Saved Addresses";
        if (path.includes("/my-profile-payments")) return "Payment Options";
