          ...
          <div className={styles.PaymentBox}>
            ...
            <div className={styles.PaymentSection}>
              ...
              {paymentMethods.map((method, index) => (
                <div key={index} className={styles.PaymentOptionContainer}>
                  <div
                    className={`${styles.PaymentOption} ${selectedMethod === index ? styles.Selected : ""
                      }`}
                    onClick={() => {
                            ...
                            >
                              <input
                                ...
                                onChange={() => {
                                  ...
                                  setSelectedPaymentMethod({ type: "upi", ...upi });
                                }}
                      ...
                      {(upiFormOpen || paymentUpi.length === 0) && (
                        <>
                          <div className={styles.InputGroup}>
                            ...
                            />
                            <p className={styles.InputHint}>For ex: yourupi@bank</p>
                          </div>
                          ...
                          <div className={styles.AgreeBox}>
                            ...
                            />
                            <label>
                              I agree to the QuickMobile Terms and Conditions and certify this info
                              is correct.
                            </label>
                          </div>
                  ...
                  {selectedMethod === index && index === 1 && (
                    <div className={styles.DropDown}>
                            ...
                            >
                              <input
                                ...
                                onChange={() => {
                                  ...
                                  setSelectedPaymentMethod({ type: "bank", ...bank });
                                }}
                                className="custom-radio"
                                style={{ display: "none" }}
                              />
                              <ul>
                                <li>Acc no : {bank?.bankDetails?.accountNumber}</li>
                                <li>IFSC Code : {bank?.bankDetails?.ifscCode}</li>
                                <li>Bank name : {bank?.bankDetails?.bankName}</li>
                                <li>Beneficiary name : {bank?.bankDetails?.beneficiaryName}</li>
                              </ul>
                            </label>
                          ))}
                      ...
                      {(bankFormOpen || paymentBank.length === 0) && (
                        <>
                          {[
                            ...
                            { key: "confirmAccountNumber", label: "Confirm Account Number" },
                            ...
                            <div className={styles.InputGroup} key={i}>
                              ...
                              <input
                                ...
                                onChange={(e) =>
                                  setBankDetails({ ...bankDetails, [field.key]: e.target.value })
                                }
                              />
                      ...
                      <div className={styles.Notice}>
                        All Banking Details are saved according to RBI guidelines.
                      </div>
                    </div>
                  )}
            ...
            <div className={styles.DetailsSection}>
              ...
              <div className={styles.IMEIInfo}>
                <p>
                  To find your IMEI number, dial *#06# or check under About Phone.
                  You can also check on the box or behind the battery.
                </p>
              </div>
