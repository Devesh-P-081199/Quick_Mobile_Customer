                ...
                {address?.length > 0 ? (
                  <>
                    {address.map((item, index) => (
                      <label
                        key={index}
                        className={`${styles.addressCard} ${selectedAddress?.id === item.id ? styles.selectedCard : ""
                          }`}
                      >
                        <input
                          type="radio"
                        ...
                        <div className={styles.addressContent}>
                          <p>{item?.houseNumber} {item?.city}</p>
                          <p>{item?.street} - {item?.zipCode}</p>
                          <p>{item?.state}</p>
                        </div>
              ...
              <div className={styles.AddressBox}>
                ...
                <div className={styles.FormBox}>
                  ...
                  <div className={styles.inputContainerGroup}>
                    <div className={` ${styles.gridBoxes}"grid grid-cols-2 gap-4 w-full "`}>
                      {/* City */}
                      <div className={styles.inputContainer}>
                  ...
                  <div className={styles.inputContainer}>
                    <label className={styles.checkboxLabel}>
                      ...
                      <span className={styles.checkboxText}>
                        ...
                        <a href="#">Trade-in Terms and Conditions</a> and certify that the
