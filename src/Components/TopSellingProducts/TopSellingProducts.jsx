  ...
  return (
    <section>
      ...
      <div className={styles.imageSection}>
        <img src={productImage} alt="iPhone 16 Pro Max" title='iphone 16 Pro Max' className={styles.productImage} />
      </div>
      ...
      <div className={styles.details}>
        ...
        <div className={styles.ratingRow}>
          <div className={styles.stars}>
            {[...Array(4)].map((_, i) => (
              <img key={i} src={starIcon} alt="star" title='star' className={styles.starIcon} />
            ))}
          </div>
