...
const filteredBrands = selectedSubCategoryId
  ? allBrands.filter((b) => b.subCategoryId?._id?.toString() === selectedSubCategoryId.toString())
  : allBrands;
                ...
                >
                  ...
                  {selectedSubCategoryId === subcata._id && (
                    <span className={styles.crossIcon}>
                      <img src={closeicon} alt="close" title="close" height={16} width={16} />
                    </span>
                  )}
                </li>
              ))}
                    ...
                    <li
                      onClick={() => {
                        if (
                          ...
                          navigate(`/${brand?.subCategoryId?.slugSell}/${brand.slugSell}`);
                        } else {
