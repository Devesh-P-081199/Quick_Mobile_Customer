              ...
              <div className={style.icons}>
                {loading ? (
                  ...
                  <>
                    <div
                      className={style.iconWrapper}
                      style={{ marginBottom: "50px" , color : "#f26921" , fontSize : "36px" }}
                    >
                      <FaCircle />
                    </div>
                    <div
                ...
                <>
                  ...
                  <div className={style.stepText}>
                    ...
                    <p>
                      ...
                      condition, our smart tech will instantly calculate the
                      best price.
                    </p>
                  </div>
                  <div className={style.stepText}>
                  ...
                  <div className={style.stepText}>
                    ...
                    <p>
                      ...
                      your payment is processed instantly straight to your UPI
                      or bank account.
                    </p>
                  </div>
                  <div className={style.stepText}>
