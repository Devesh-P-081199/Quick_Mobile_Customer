  ...
  const fetchCategories = async () => {
    ...
    try {
      ...
      console.log("allCategories", allCategories);
       setbannerimg(allCategories[0].categoryBannerUrl)
          ...
          <div className={styles.rightContent}>
            ...
            <div className={styles.searchBox}>
              <div className={styles.searchContainer}>
                ...
                {showDropdown && !isMobileSearchOpen && (   // ✅ prevent double rendering
              ...
              {isLoadingBrands
                ...
                : brands.slice(0, 4).map((icon, index) => (
                  <div key={index}>
                    ...
                    >
                      <img src={icon?.brandLogo} alt={icon?.brandName} title={icon?.brandName} />
                    </div>
            ...
            {/* ✅ Same for mobile */}
            {!isLoadingBrands && brands.length > 4 && (
              <span className="mobile-viewall" onClick={onViewAllClick}>
                view all
              </span>
            )}
          </div>
