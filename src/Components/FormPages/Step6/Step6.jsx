...
function Step6() {
  const { allPackageData, currentEvaluationId, setCurrentEvaluationId,userSelection } =
  ...
  const FetchPriceDetails = async () => {
    setLoading(true);
    console.log("Fetching final price details...");
    try {
        ...
        <div className={styles.wrapper}>
          ...
          <div className={styles.LeftBox}>
            <div className={styles.DeviceImg}>
              ...
              <div className={styles.DeviceDetails}>
                ...
                {!loading && (
                  <>
                    <NavLink to={`/${slug}/final-price-calculator?${queryParams.toString()}`} className={styles.recalculate}>
                      <img
                        src={Recalculate}
                        alt="Recalculate"
          ...
          <div className={styles.deviceDetailsBtn}>
            <button onClick={() => setShowAnswersModal(true)}>
              Device Details <span><img src={arrow} alt="" /></span>
            </button>
          </div>
            ...
            <div className={styles.simpleModal} onClick={(e) => e.stopPropagation()}>
              ...
              <div className={styles.modalContentWrapper}>
                <div className={styles.modalIcon}>
                  <i className="fas fa-ticket-alt"></i> {/* You can use react-icons instead */}
                </div>
