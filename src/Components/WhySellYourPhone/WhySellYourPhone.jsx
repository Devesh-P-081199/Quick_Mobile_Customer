    ...
    <section className="default-padding-section md-none">
      <div className="wrapper">
        <div className={styles.wrapper}>
          <h1 className={`${styles.sectionHeading} section-heading font-hedving`}>
          ...
          <div className={styles.cardsBox}>
            ...
            <div className={styles.card}>
              <div className={styles.upper}>
                ...
                <h3 className="text-lg font-semibold">
                  Quick and <span className="underline text-[#EBFFCB] px-1">Easy</span> Quotes.
                </h3>
              </div>
            ...
            <div className={styles.card}>
              <div className={styles.upper}>
                ...
                <h3 className="text-lg font-semibold">
                  <span className="underline text-[#D2CBFF] px-1">Instant</span> <br /> Cash.
                </h3>
              </div>
              <div className={styles.lower}>
                <span>Get quote for your phone in just few cliks</span>
            ...
            <div className={styles.card}>
              <div className={styles.upper}>
                ...
                <h3 className="text-lg font-semibold">
                  ...
                  <span className="underline text-[#FFEACB] px-1">24 Hours</span>.
                </h3>
              </div>
              <div className={styles.lower}>
                <span>Get quote for your phone in just few cliks</span>
