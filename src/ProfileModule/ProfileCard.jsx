...
import { FaSignOutAlt, FaMapMarkerAlt, FaCreditCard, FaBoxOpen, FaEdit, FaPen } from 'react-icons/fa';
    ...
    <MobileCommonHeaderthree title = "Profile"  />
      ...
      <div className={styles.options}>
         <div className={styles.optionRow}>
          <FaBoxOpen />
          <span onClick={() => navigate("/edit-my-profile")}>Edit Profile <img src={rightangle} alt="" /></span>
        </div>
        <div className={styles.optionRow}>
          <FaBoxOpen />
          <span onClick={() => navigate("/my-profile-orders")}>My Orders <img src={rightangle} alt="" /></span>
        </div>
        <div className={styles.optionRow}>
          <FaCreditCard />
          <span onClick={() => navigate("/my-profile-payments")}>Payments Options <img src={rightangle} alt="" /></span>
        </div>
        <div className={styles.optionRow}>
          <FaMapMarkerAlt />
          <span onClick={() => navigate("/Address")}>Saved Address <img src={rightangle} alt="" /></span>
        </div>
        <div className={styles.optionRow}>
          <FaMapMarkerAlt />
          <span onClick={() => navigate("/offers")}>Offer <img src={rightangle} alt="" /></span>
        </div>
        <div className={styles.optionRow}>
          <FaSignOutAlt />
          <span onClick={handleLogOut}>Logout <img src={rightangle} alt="" /></span>
        </div>
      </div>
    </div>
