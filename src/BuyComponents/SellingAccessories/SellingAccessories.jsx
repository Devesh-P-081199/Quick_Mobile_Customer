...
const SellingAccessories = () => {
  ...
  return (
    <section className="w-full  flex flex-col items-center mx-auto gap-8">
      ...
      <div
        ref={scrollRef}
        className="w-full max-w-6xl flex gap-4 overflow-x-auto  padding-margin-balance whitespace-nowrap scrollbar-hidden"
      >
