const Blogs = () => {
    return (
      <section className="blogs-section zero-padding-section">
        <div className="blogs-container">
          ...
          <div className="blogs-grid">
            ...
            <div className="blog-card bg-green">
              <div className="blog-card-overlay">
                <p className="blog-overlay-text">
                  We’ve prevented <br /> <a href="" className="text-[#EBFFCB]"> 1 million tons</a> of carbon emissions.
                </p>
              </div>
            ...
            <div className="blog-card bg-purple">
              <div className="blog-card-overlay">
                <p className="blog-overlay-text">
                  The environmental impact of  <a href="" className="text-[#D2CBFF]">  refurbished tech </a>
                </p>
              </div>
              <div className="blog-content">
                <h2 className="blog-title">Reduction in E-Waste</h2>
            ...
            <div className="blog-card bg-orange">
              <div className="blog-card-overlay">
                <p className="blog-overlay-text">
                <a href="" className="text-[#FFEACB]"> Refurbished </a>is better than Used.
                </p>
              </div>
              <div className="blog-content">
                <h2 className="blog-title">Reduction in E-Waste</h2>
            ...
            <div className="blog-card bg-blue">
              <div className="blog-card-overlay">
                <p className="blog-overlay-text">
                  How buying Refurbished tech   <a href="" className="text-[#CBDDFF]">helps the planet. </a>
                </p>
              </div>
              <div className="blog-content">
                <h2 className="blog-title">Reduction in E-Waste</h2>
